...
function buildInput(value: ChildWizardFormState): CreateChildInput {
  return {
    ...
    approvedDirectHours: parseHoursInput(value.approvedDirectHours),
    approvedIndirectHours: parseHoursInput(value.approvedIndirectHours),
    vorviertelstunde: value.vorviertelstunde,
    nachviertelstunde: value.nachviertelstunde,
    ausflugSchullandheim: value.ausflugSchullandheim,
