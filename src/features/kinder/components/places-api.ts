...
// Thin wrapper around google.maps.places.AutocompleteSuggestion (the modern
// API that replaces the legacy AutocompleteService used by
// use-places-autocomplete). Manages query state, debounced fetches, session
// tokens for billing, and a status flag for the UI.
