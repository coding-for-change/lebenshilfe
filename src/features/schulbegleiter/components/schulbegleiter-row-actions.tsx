...
import {
  deleteSchulbegleiterAction,
  resendSchulbegleiterInvitationAction,
} from "../actions";
...
export function SchulbegleiterRowActions({
  profileId,
  name,
  status,
  onEdit,
  ...
  async function handleResend() {
    setResending(true);
    try {
      await resendSchulbegleiterInvitationAction(profileId);
  ...
  async function handleDelete() {
    try {
      await deleteSchulbegleiterAction(profileId);
