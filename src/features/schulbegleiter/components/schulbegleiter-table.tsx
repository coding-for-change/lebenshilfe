...
import { SchulbegleiterRowActions } from "./schulbegleiter-row-actions";
import { SchulbegleiterWizard } from "./schulbegleiter-wizard";
...
export function SchulbegleiterTable({ profiles, workshops }: Props) {
